...
def build_initial_prompt(
    ...
    *,
    ...
    return (
        f"{budget_line}\n\n"
        "ML benchmark. Каждый ответ начинай с отдельной строки EDA, FEATURES или TRAIN. "
        "На второй строке кратко напиши, что собираешься сделать, без вводного слова; "
        "затем укажи агентские команды, по одной на строку. "
...
def build_parse_error_prompt(
    ...
    return (
        ...
        "Затем верни валидные команды, по одной на строку.\n\n"
