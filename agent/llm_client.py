...
Формат ответа:
- Можно написать одну короткую строку о следующем действии, затем одну или несколько агентских команд.
...
- Для табличных задач сравни baseline с более сильными моделями, используй честную валидацию и улучшай по метрике задачи.
- Перед submit проверь, что файл с твоим решением существует, имеет правильный формат и содержит нужные предсказания.
- Если система явно сообщает FINALIZATION MODE, прекращай улучшения и вызывай submit("название файла с твоим решением") с лучшим подготовленным файлом."""
