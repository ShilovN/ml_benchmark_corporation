...
- Первая строка должна быть ровно одним из трех этапов: EDA, FEATURES или TRAIN.
- Вторая строка — один короткий комментарий о следующем действии без вводного слова или специального префикса.
